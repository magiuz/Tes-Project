...
tersebut! 
        ...
        */
        ...
        echo "<br>Panjang String = " . strlen("Hello PHP!");
        echo "<br>Jumlah Kata = " . str_word_count("Hello PHP!");

        $second_sentence = "I'm ready for the challenges"; // Panjang string: 28,  jumlah kata: 5
        //output sechond_sentence
        echo "<br><br>Second Sentence = " . $second_sentence;
        ...
        */
        ...
        //Str_replace
        echo "<br>Ubah Kata Good! Jadi awesome!" ."<br><br> Hasil Nya : ". str_replace("Good!","awesome!",$string3);
